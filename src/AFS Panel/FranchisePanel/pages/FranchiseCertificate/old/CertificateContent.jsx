      ...
      <View style={styles.section}>
        ...
        <View style={styles.section2}>
          ...
          <Text style={styles.text3}>
            has been authorised to run all courses under M-Tech Computer
            EDUCATION in his/her Centre Name - {branchData.centerName}
          </Text>
          <Text style={styles.text4}>
            <Text style={styles.atText}>at -</Text> {branchData.district},{" "}
            {branchData.state}
          </Text>
        </View>
        <Text style={styles.date}>
          {new Date(branchData.createdAt).toLocaleDateString("en-GB")}
        </Text>
